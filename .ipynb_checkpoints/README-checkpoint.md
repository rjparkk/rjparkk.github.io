# Data Analysis Portfolio by Richard Park
...
The objective build models to predict quality of wines (Logistic Regression, kNN, and Random Forest Models). Models are compared to see which is most effecient at predicting the quality of wine.
